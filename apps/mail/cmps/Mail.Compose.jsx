...
return (
    <form className={`mail-compose flex column ${loadingClass}`}
        ...
        <input onChange={handleChange} type="text" name="to"
            id="to" value={to} placeholder="To"></input>

        <input onChange={handleChange} type="text" name="subject"
            id="subject" value={subject} placeholder="Subject"></input>

        <textarea onChange={handleChange} name="body" id="body" value={body}></textarea>
